...
# Defini os estados para uma melhor manipulação:
e = ['SP', 'RJ', 'MG', 'ES', 'OUTROS']

faturamento = list()
for c in e:
    # Captura e tratando os valores digitados:
    while True:
        try:
    ...
    # Armazena os valores digitados na lista faturamento
...
# Calcula e exibi o percentual relativo de cada filial de cada estado:
cont = 0
